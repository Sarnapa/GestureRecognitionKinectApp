...
namespace GestureRecognition.Tests.Applications.GestureRecordsAndDataServiceConsoleApp.UnitTests
{
	...
	public sealed class GestureFeaturesManagerTests
	{
		...
		private const string KINECT_INPUT_DIR_PATH = @"C:\Users\Michal\OneDrive\Studies\Praca_MGR\Project\Data\ASLGestures\Goodbye\2025_08_14\Kinect\";
		private const string KINECT_INPUT_FILE_PATH = $"{KINECT_INPUT_DIR_PATH}20250202_Goodbye1.record";
		private const string KINECT_OUTPUT_DIR_PATH = @"C:\Users\Michal\OneDrive\Studies\Praca_MGR\Project\Data\ASLGestures\Goodbye\2025_08_14\Kinect\Test\";
		private const string KINECT_OUTPUT_FILE_PATH = $"{KINECT_OUTPUT_DIR_PATH}20250202_Goodbye1.record";
		private const string MEDIAPIPE_HAND_LANDMARKS_INPUT_DIR_PATH = @"C:\Users\Michal\OneDrive\Studies\Praca_MGR\Project\Data\ASLGestures\Goodbye\2025_08_14\MediaPipeHandLandmarks\";
		...
		private const string MEDIAPIPE_HAND_LANDMARKS_OUTPUT_DIR_PATH = @"C:\Users\Michal\OneDrive\Studies\Praca_MGR\Project\Data\ASLGestures\Goodbye\2025_08_14\MediaPipeHandLandmarks\Test\";
